...
Ext.extend(Monaco.Editor,
    Ext.Component,
    {
        ...
        cfg: {
            ...
            formatOnPaste: MODx.config['monaco.format_on_paste'] ? MODx.config['monaco.format_on_paste'] === "1" : false,
            formatOnType: MODx.config['monaco.format_on_type'] ? MODx.config['monaco.format_on_type'] === "1" : false,
